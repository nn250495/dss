...
return [
    ...
    'components' => [
        ...
        'viewed' => [
            'class' => 'frontend\components\Viewed',
        ],
        'authManager' => [
    ...
    'modules' => [
        ...
        'gallery' => [
            ...
            'imagesCachePath' => dirname(dirname(__DIR__)).'/frontend/web/images/store', //path to resized copies
            'graphicsLibrary' => 'GD',
            'placeHolderPath' => '@frontend/images/placeHolder.jpg',
        ],
        'order' => [
