                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-4 sort-group">
                        <label>
                            ...
                            <a href="<?=Url::toRoute(['/search/result', 'search' => Yii::$app->request->get('search'), 'sort' => 'cheap', 'perpage' => $perpage]);?>" <?php if($sort == 'cheap') echo ' style="font-weight: bold;"'; ?>>дешевые</a> или
                            <a href="<?=Url::toRoute(['/search/result', 'search' => Yii::$app->request->get('search'), 'sort' => 'expensive', 'perpage' => $perpage]);?>" <?php if($sort == 'expensive') echo ' style="font-weight: bold;"'; ?>>дорогие</a>
                        </label>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-4 sort-group">
                        <label>
                            ...
                            <a href="<?=Url::toRoute(['/search/result', 'search' => Yii::$app->request->get('search'), 'sort' => $sort, 'perpage' => 50]);?>" <?php if($perpage == 50) echo ' style="font-weight: bold;"'; ?>>50</a> или
                            <a href="<?=Url::toRoute(['/search/result', 'search' => Yii::$app->request->get('search'), 'sort' => $sort, 'perpage' => 100]);?>" <?php if($perpage == 100) echo ' style="font-weight: bold;"'; ?>>100</a>
                        </label>
                    </div>
                </div>
            </div>
